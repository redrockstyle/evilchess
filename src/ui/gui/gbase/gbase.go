...
type Palette struct {
	...
	Accent       color.RGBA
	ModalBg      color.RGBA
	SquareLight  color.RGBA
	SquareDark   color.RGBA
}
...
var LightPalette = Palette{
	...
	SquareLight:  color.RGBA{0x88, 0x88, 0x88, 0xff},
	SquareDark:   color.RGBA{0xf7, 0xf7, 0xf7, 0xff},
}

var DarkPalette = Palette{
	Bg:         color.RGBA{0x25, 0x25, 0x25, 0xff},
	ButtonFill: color.RGBA{0x33, 0x33, 0x33, 0xff},
